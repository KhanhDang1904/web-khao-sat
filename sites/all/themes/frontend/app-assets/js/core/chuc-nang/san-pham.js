$(document).ready(function () {
  $(document).on('click', '#btn-them-moi', function (e) {
    ...
    $("#title-modal-san-pham").text('Thêm sản phẩm');
  ...
  $(document).on('click', '.btn-save', function (e) {
    e.preventDefault();
    var $data = new FormData(document.getElementById("form-san-pham"));
    $data.append('field_mo_ta', CKEDITOR.instances['editor'].getData())
    $.ajax({
      url: '/save-san-pham',
      data: $data,
      dataType: 'json',
  ...
  $(document).on('click', '.btn-them-row', function (e) {
    ...
    $("#danh_sach_vot tbody").append("<tr>" + $(".block-row").html() + "</tr>")
  })
