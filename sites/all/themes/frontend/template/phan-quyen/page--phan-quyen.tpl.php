      ...
      <ul class="nav navbar-nav flex-row">
        <li class="nav-item me-auto">
          <a class="navbar-brand" href="#">
            ...
            <h2 class="brand-text mb-0">PHÂN QUYỀN</h2>
          </a>
        </li>
...
<div class="app-content content ">
  ...
  <div class="content-wrapper container-xxl p-0">
    ...
    <div class="content-body">
     ...
     <?php if(user_access('phan_quyen_permission')):?>
      <?php
      $roles = getRoles();
      $perms = getListPermissionByModule('quan_ly_tac_nghiep_web'); // module_invoke("", 'permission');
      ?>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header row">
              <div class="content-header-left col-md-9 col-12">
                <div class="row breadcrumbs-top">
                  <div class="col-12">
                    <h4 class="card-title text-phan-quyen">Danh sách phân quyền</h4>
                  </div>
                </div>
              </div>
            </div>
            <div class="table-responsive overflow-x-unset">
              <form id="idPhanQuyen">
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    <th width="1%">TT</th>
                    <th>Chức năng</th>
                    <th class="text-nowrap">Ẩn danh</th>

                    <?php foreach ($roles as $role): ?>
                      <th width="1%" class="text-nowrap"><?= $role->name ?></th>
                    <?php endforeach; ?>
                  </tr>
                  </thead>
                  <tbody>
                  <?php $stt = 0; ?>
                  <?php foreach ($perms as $perm => $item): ?>
                    <?php $stt++; ?>
                    <tr>
                      <th width="1%" class="text-nowrap text-center"><?= $stt ?></th>
                      <th class="text-nowrap"><?= $item['title'] ?></th>
                      <th width="1%" class="text-nowrap ">
                        <div class="form-check form-check-primary text-center">
                          <input <?=existingPerm($perm,1)==TRUE?"checked":""?> type="checkbox" name="user_perm[1][]"
                                                                                        value="<?= $perm ?>" class="form-check-input">
                        </div>
                      </th>
                      <?php foreach ($roles as $index => $role): ?>
                        <th width="1%" class="text-nowrap ">
                          <div class="form-check form-check-primary text-center">
                            <input <?=existingPerm($perm,$role->rid)==TRUE?"checked":""?> type="checkbox" name="user_perm[<?= $role->rid ?>][]"
                                                                                          value="<?= $perm ?>" class="form-check-input">
                          </div>
                        </th>
                      <?php endforeach; ?>
              ...
              <div class="col-12 text-center mt-2 mb-1 pt-50">
                <a href="#" class="btn btn-success btn-luu-phan-quyen">Lưu lại</a>
              </div>
            </div>
